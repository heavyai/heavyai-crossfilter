...
function unBinResults(queryBinParams, results) {
   ...
   * Binning is a way to group quantitative (and, distressingly, temporal) data, e.g.
...
var _binning = __webpack_require__(117);

var _groupUtilities = __webpack_require__(116);
        ...
        function dimension(expression, isGlobal) {
            ...
            function group() {
                ...
                function size(ignoreFilters, callback) {
                    ...
                    var sizeAsync = (0, _groupUtilities.sizeAsyncWithEffects)(queryTask, writeFilter);
                    var sizeSync = (0, _groupUtilities.sizeSyncWithEffects)(queryTask, writeFilter);
                    if (callback) {
