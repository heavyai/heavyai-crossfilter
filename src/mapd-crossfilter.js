            ...
            function group() {
                ...
                function getProjectOn(isRenderQuery, queryBinParams) {
                    ...
                    for (var d = 0; d < dimArray.length; d++) {
                        ...
                        } else if (columnTypeMap[compoundColumnMap[dimArray[d]]].is_array) { // Code changes by Sachin replaced dimContainsArray[d] with columnTypeMap[compoundColumnMap[dimArray[d]]].is_array
                            projectExpressions.push(
