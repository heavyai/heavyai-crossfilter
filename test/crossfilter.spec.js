  ...
  describe(".dimension", () => {
    ...
    describe(".filterMulti", () => {
      ...
      it("OR concats if drillDownFilter not set", () => {
        expect(dimension.filterMulti([1, 2], null, undefined)).to.eql(
          dimension
        );
    ...
    describe(".filterLike", () => {
      it("escapes apostrophes in filter values", () => {
        ...
        expect(dimension.getFilterString()).to.eq(
          "bargle like '%McDonald''s%'"
        );
        dimension.filterAll(null);
        dimension.filterLike("'til later");
        expect(dimension.getFilterString()).to.eq(
          "bargle like '%''til later%'"
        );
        dimension.filterAll(null);
    ...
    describe(".multiDim", () => {
      ...
      it("should set whether dimension is multi", () => {
        ...
        return crossfilter
          ...
          .then(crsfltr => {
            expect(
              crsfltr.dimension(["argle", "bargle"]).multiDim(false).multiDim()
            ).to.equal(false);
          });
      });
    });
    ...
    describe(".group", () => {
      ...
      describe(".getProjectOn", () => {
        ...
        it("handles date bin bounds with undefined timed bin", () => {
          ...
          const filterRange = (binParams.binBounds[1].getTime() -
